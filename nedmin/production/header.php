  ...
  <body class="nav-md">
    <div class="container body">
     ...
     <li><a href="kullanici.php"><i class="fa fa-user"></i> İstifadəçi </a></li>
      ...
      <li><a href="yorum.php"><i class="fa fa-list"></i> Yorum</a></li>
       <li><a href="banka.php"><i class="fa fa-bank"></i> Banklar </a></li>
     <li><a href="menu.php"><i class="fa fa-list"></i> Menu </a></li>
     <li><a href="siparis.php"><i class="fa fa-list"></i> Sifarişlər </a></li>
