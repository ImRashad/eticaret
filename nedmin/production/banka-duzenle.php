...
?>
 ...
 <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name"> Hesab AdSoyad <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                        <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                         ...
                         <input type="hidden" name="banka_id" value="<?php echo $bankacek['banka_id'] ?>">
                          ...
                          <button type="submit" name="bankaduzenle" class="btn btn-success">Yenilə</button>
                        </div>
                      </div>
