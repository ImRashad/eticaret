...
<option  <?php  if ($kategori_id==$urun_id) { echo "selected='select'";} ?> value="<?php echo $kategoricek['kategori_id'] ?>"  >
  ...
  <?php echo $kategoricek['kategori_ad'] ?>  </option>
       ...
       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                               <textarea name="urun_detay" class="ckeditor"><?php echo $uruncek['urun_detay'] ?></textarea>
                        </div>
                      </div>
...
<div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" name="urun_keywords" value="<?php echo $uruncek['urun_keywords'] ?>" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
...
<option value="1" <?php echo $uruncek['urun_durum'] == "1" ? 'selected=""' : '' ; ?>>Aktiv</option>


<option value="0" <?php echo $uruncek['urun_durum'] == "0" ? 'selected=""' : '' ; ?>>Passiv</option>
