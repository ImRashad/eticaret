    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_title">
             <div align="left" class="col-md-6">
              <h2 >Resim Ürün Fotoğraf İşlemleri <small>
                ...
                <b style="color:green;">Əməliyyat uğurla keçirildi...</b>

                <?php } elseif ($_GET['durum']=='no')  {?>

                <b style="color:red;">Əməliyyatda səhv var...</b>
              ...
              <div class="x_content">
                ...
                $sorgu=$db->prepare("SELECT * from urun_foto");
                $sorgu->execute();
        ...
        // toplam sayfa sayımızdan fazla yazılırsa en son sayfayı varsayalım.
                ...
                $urunfotosor=$db->prepare("SELECT * from urun_foto where urun_id=:urun_id order by urunfoto_id DESC limit $limit,$sayfada");
