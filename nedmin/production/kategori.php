...
<a href="kategori-ekle.php"><button class="btn btn-success btn-xs" >Əlavə et</button></a>
...
<?php   }  ?>
                          ...
                          <td><center><a href="kategori-duzenle.php?kategori_id=<?php echo $kategoricek['kategori_id'] ?>"> <button  class="btn btn-primary btn-xs">Düzəlmə</button> </a> </center></td>
